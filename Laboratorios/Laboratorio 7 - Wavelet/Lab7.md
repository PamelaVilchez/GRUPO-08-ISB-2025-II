...
La metodología empleada es reproducible y compatible con entornos de adquisición en campo. El uso de PyWavelets y Matplotlib permitió documentar cada paso del procesamiento, asegurando trazabilidad. En cuanto a la transformada wavelet continua (CWT) con Morlet, esta mostró concentraciones de energía en escalas bajas-medias (20-40), en los segundos 0.75 y 0.80, lo que sugiere actividad cerebral sostenida en rangos Theta y beta.. Si bien la señal fue adquirida post-ejercicio, lo que introduce artefactos musculares, el enfoque aplicado demostró ser robusto frente a estas condiciones. Se recomienda complementar el procesamiento con técnicas de corrección de línea base y validar con métodos alternativos como EMD o wavelet scattering para escenarios clínicos más exigentes.
